...
3- Puede crearse una aplicación nueva en `desarrollo/aplicaciones` (ver [Estructura](estructura.md)), o bien instalarse la aplicación de ejemplo:

Para ello, primero se debe editar el archivo `desarrollo/aplicaciones/ejemplo/config.php` asignando los parámetros correctos de la base de datos.

Instalar la base de datos de la aplicación de ejemplo:
