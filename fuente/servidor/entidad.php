...
class entidad {
    ...
    public static function obtenerCampos() {
        ...
        foreach($propiedades as $propiedad=>$v) {
            ...
            if(preg_match_all("/@(tipo|relacion|contrasena|indice|modelo|relacion|columna|privado|predeterminado|requerido|tamano|etiqueta|omitir|oculto|busqueda|orden|publico|html)( (.+?))?(\r|\n|\*\/)/s",$comentario,$coincidencias)) {
