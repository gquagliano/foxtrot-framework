<!doctype html><html lang="es"><head>
  ...
  <body>
    <div id="foxtrot-cuerpo" class="componente vista contenedor" data-fxid="abm-usuario-2"><div class="componente contenedor container-fluid abm-usuario-contenedor-4" data-fxid="abm-usuario-3">
        ...
        <a href="#" data-fxid="abm-usuario-63" class="componente btn btn-primary boton abm-usuario-boton-64 mr-2">Guardar</a>
        <a href="#" data-fxid="abm-usuario-65" class="componente btn btn-secondary boton abm-usuario-boton-66 mr-2">Nuevo</a>
        <a href="#" data-fxid="abm-usuario-67" class="componente btn btn-secondary boton abm-usuario-boton-68">Volver</a>
    </div></div>
